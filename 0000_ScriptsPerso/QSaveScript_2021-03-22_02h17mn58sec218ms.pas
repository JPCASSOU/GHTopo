...
begin
  ...
  begin
    ...
    PS2D_BeginPolyline('Poly1', True);
      ...
      PS2D_AddVertex(-23, 46);

    PS2D_EndPolyline();


    PS2D_SetStyleSheet(1)
    Nb := PS2D_AddStyleSheet('MonStyleEllipses',
                            0, 255, 0, 255, 4,
                            0, 12, 240, 122, 0,
                            'Arial', 0, 0, 0, 255, 12, 0);
    if (Nb >= 0) then PS2D_SetStyleSheet(Nb);

    PS2D_AddEllipse(20, -44, 12, 15);
    PS2D_AddTexte(12, -45, 34, 0, 'Fuck The Christ');
    PS2D_AddRectangle(-10, -20, 45, 5);
    PS2D_AddLine(-45, 34, 33, -55);
