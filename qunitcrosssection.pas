...
begin
  try
    ...
    FListeCourbes.Free;
    FListePolygones.Free;
    FListeSimpleLignes.Free;
    FListeTextes.Free;
  end;
end;
...
function TCrossSection.Serialiser(out LS: TStringList): boolean;
  ...
  begin
    Result := Format(FORMAT_NB_REAL_3_DEC, [V]);
  end;
  ...
  begin
    ...
    WU := WU + Format(FORMAT_NB_INTEGER + #9 + FORMAT_NB_REAL_3_DEC + #9 + FORMAT_NB_REAL_3_DEC + #9 +'%s',
  ...
  begin
    ...
    WU := WU + Format(FORMAT_NB_INTEGER + #9 + FORMAT_NB_REAL_3_DEC + #9 + FORMAT_NB_REAL_3_DEC + #9 + FORMAT_NB_REAL_3_DEC + #9 + FORMAT_NB_REAL_3_DEC,
