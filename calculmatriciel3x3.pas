...
function DeltaKronecker(const i, j: integer): double;
...
function MultMatrix3x3ByScalar(const A: TMatrix3x3; const k: double): TMatrix3x3;
function MaxNormeMatrix3x3(const M: TMatrix3x3): double;
...
// norme euclidienne
function NormeVecteur(const V: TPoint3Df): double;
...
// rotations
function makeMatRotationX(const Angle: double): TMatrix3x3;
var
  cosa, sina: double;
begin
...
function makeMatRotationY(const Angle: double): TMatrix3x3;
var
  cosa, sina: double;
begin
  sincos(Angle, sina, cosa);
...
function makeMatRotationZ(const Angle: double): TMatrix3x3;
var
  cosa, sina: double;
begin
  sincos(Angle, sina, cosa);
