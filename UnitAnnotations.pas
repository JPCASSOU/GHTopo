...
{$ERROR Unité inutilisée à supprimer}
    ...
    try
      ...
      for i:=0 to self.Count -1 do
        begin
            ...
            //AN.X
            Ligne:=Format(FORMAT_NB_INTEGER + TAB +              // FA_COL_ID_ANN      = 0;
                          FORMAT_NB_INTEGER + TAB +  // FA_COL_MODE_POS    = 1;
                          FORMAT_NB_INTEGER + TAB +           // FA_COL_BASEPT_SER  = 2;
                          FORMAT_NB_INTEGER + TAB +         // FA_COL_BASEPT_ST   = 3;
                          FORMAT_NB_INTEGER + TAB +         // FA_COL_BASEPT_POS  = 4; Point de base: centré, justifié, etc ...
                          ...
                          FORMAT_NB_INTEGER + TAB +               // FA_COL_TXT_COLOR_R = FA_COL_BASEPT_OF_Z + 1; // Caractéristiques du texte: couleur, limite, fonte, taille, caractères
                          FORMAT_NB_INTEGER + TAB +               // FA_COL_TXT_COLOR_G = FA_COL_BASEPT_OF_Z + 2;
                          FORMAT_NB_INTEGER + TAB +               // FA_COL_TXT_COLOR_B = FA_COL_BASEPT_OF_Z + 3;
                          FORMAT_NB_INTEGER + TAB +       // FA_COL_TXT_MAX_LG  = FA_COL_BASEPT_OF_Z + 4; // longueur max
                          '%s' + TAB +           // FA_COL_TXT_FONT    = FA_COL_BASEPT_OF_Z + 5; // nom de fonte
                          FORMAT_NB_INTEGER + TAB +          // FA_COL_TXT_SIZE    = FA_COL_BASEPT_OF_Z + 6; // taille du texte
                          FORMAT_NB_INTEGER + TAB +            // FA_COL_TXT_BOLD    = FA_COL_BASEPT_OF_Z + 7; // gras
                          FORMAT_NB_INTEGER + TAB +          // FA_COL_TXT_ITALIC  = FA_COL_BASEPT_OF_Z + 8; // italique
                          FORMAT_NB_INTEGER + TAB +       // FA_COL_TXT_UNDERLN = FA_COL_BASEPT_OF_Z + 9; // souligné
                          FORMAT_NB_INTEGER + TAB +      // affiché
                          FORMAT_NB_INTEGER + TAB +      // réservé
