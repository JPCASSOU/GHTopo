...
const
  FMT_COORDS = FORMAT_NB_REAL_3_DEC;
  FMT_DEGDEC = '%.3f°';
var
  dx, dy, dz, dp: Double;
  qL, qAZ, qP: double;
begin
  ...
  GetBearingInc(dx, dy, dz, qL, qAZ, qP, UNITE_ANGULAIRE_PAR_DEFAUT, UNITE_ANGULAIRE_PAR_DEFAUT);
  ...
  lbAzimut.Caption       := Format(, [qAZ]); ;
  lbInclinaison.Caption  := Format(degd, [qP]);
end;
